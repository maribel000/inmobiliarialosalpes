 ...
 * @author DANIEL
 */
public class Vendedor implements ICliente
{
    // -----------------------------------------
    // Atributos
    // -----------------------------------------
    ...
    public Vendedor()
    {
        inmueblesInscritos = new ArrayList<IInmueble>();
    }
     ...
     */
    public void agregarNuevoInmueble( IInmueble nuevo )
    {
        inmueblesInscritos.add(nuevo);
    }
